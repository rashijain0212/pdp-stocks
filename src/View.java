public class View {
  ...
  void displayAllPortfolioSaved(String path){
    System.out.println("All the portfolio created have been saved and It is in the location: " +
            path);
    System.out.println();
  }
  ...
  void displayDataNotInProperFormat(){
    System.out.println("The portfolio provided in the text file is not in proper format," +
